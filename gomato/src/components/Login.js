    ...
    return (
        <div className='flex relative flex-col gap-6 px-10 rounded-xl mt-36 py-20 lg:w-[500px] md:w-[500px] w-[300px]  ml-[50%] -translate-x-[50%] items-center mb-20 bg-blackish text-white justify-center'>
            ...
            <form className='flex flex-col gap-5'>
                ...
                <button className='lg:w-96 md:w-96  w-52  bg_slider2 font-semibold text-lg py-3 rounded-xl pl-3 text-blackish bg-yellowish outline-none'>Log In</button>
            </form>
            {/* overlay bg */}
            <div className='absolute'>
                <img src={waves} alt='logo' className='w-full h-[70vh]' />
            </div>
        </div>
    )
}
