...
const Productcard = ({ logo, product_name, price }) => {
    return (
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1 }} className='w-80  flex flex-col items-center justify-center gap-2 cursor-pointer hover:shadow-lg hover:scale-105 transition-all shadow-gray border-ghee border rounded-xl py-5 px-5'>
