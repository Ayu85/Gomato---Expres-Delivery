...
const Foodbuttons = () => {
  return (
    <div className='flex items-center flex-wrap justify-center px-5 mt-5 gap-8 py-10 md:flex-wrap sm:flex-wrap lg:justify-evenly lg:px-4 lg:flex-nowrap sm:justify-center md:justify-center'>
